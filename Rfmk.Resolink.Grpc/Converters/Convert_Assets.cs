...
{
    public static AssetResponse ToProto(this ResoniteLink.AssetData self) => new()
    {
        AssetUrl = self.AssetURL.ToProto(),
    };

    public static ResoniteLink.ImportTexture2DRawData ToModel(this Texture self) => new()
    {
    ...
    public static ResoniteLink.ImportMeshJSON ToModel(this MeshJson self) => new()
    {
    ...
    private static ResoniteLink.Vertex ToModel(this Vertex self) => new()
    {
    ...
    private static ResoniteLink.UV_Coordinate ToModel(this UVCoordinate self) => self.CoordCase switch
    {
    ...
    private static ResoniteLink.BoneWeight ToModel(this BoneWeight self) => new()
    {
        BoneIndex = self.BoneIndex,
        Weight = self.Weight,
    };

    private static ResoniteLink.Submesh ToModel(this Submesh self) => self.MeshKindCase switch
    {
    ...
    private static ResoniteLink.Triangle ToModel(this Triangle self) => new()
    {
    ...
    private static ResoniteLink.Bone ToModel(this Bone self) => new()
    {
        Name = self.Name,
        BindPose = self.BindPose.ToModel(),
    };

    private static ResoniteLink.BlendShape ToModel(this BlendShape self) => new()
    {
        Name = self.Name,
        Frames = self.Frames.Select(ToModel).ToList(),
    };

    private static ResoniteLink.BlendshapeFrame ToModel(this BlendShapeFrame self) => new()
    {
    ...
    public static ResoniteLink.ImportMeshRawData ToModel(this MeshRaw self) => new()
    {
        RawBinaryPayload = self.Data.ToByteArray(),
    ...
    private static ResoniteLink.SubmeshRawData ToModel(this RawSubmesh self) => self.SubmeshCase switch
    {
    ...
    private static ResoniteLink.BlendShapeRawData ToModel(this RawBlendshape self) => new()
    {
        Name = self.Name,
    ...
    private static ResoniteLink.BlendShapeFrameRawData ToModel(this RawBlendshapeFrame self) => new()
    {
        Position = self.Position,
    };

    public static ResoniteLink.ImportAudioClipRawData ToModel(this RawAudioClip self) => new()
    {
        RawBinaryPayload = self.Data.ToByteArray(),
