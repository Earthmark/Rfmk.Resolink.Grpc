...
public static partial class Convert
{
    ...
    private static Color ToProto(this ResoniteLink.color self)
    {
        return new Color
        {
            R = self.r,
    ...
    private static ResoniteLink.color ToModel(this Color self)
    {
    ...
    private static ColorX ToProto(this ResoniteLink.colorX self)
    {
        return new ColorX
        {
            R = self.r,
    ...
    private static ResoniteLink.colorX ToModel(this ColorX self)
    {
        return new ResoniteLink.colorX
        {
            r = self.R,
            g = self.G,
            b = self.B,
    ...
    private static Color32 ToProto(this ResoniteLink.color32 self)
    {
        return new Color32
        {
            R = self.r,
    ...
    private static ResoniteLink.color32 ToModel(this Color32 self)
    {
        return new ResoniteLink.color32
        {
            r = (byte)self.R,
            g = (byte)self.G,
            b = (byte)self.B,
    ...
    private static decimal ToModel(this Decimal self)
    {
        return self.Units + self.Nanos / NanoFactor;
    }
}