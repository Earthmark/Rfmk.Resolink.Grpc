...
public interface ILinkConnection
{
    ...
    Task<AssetResponse> ImportTextureFileAsync(ImportFileRequest request, CancellationToken cancellationToken = default);
    Task<AssetResponse> ImportAudioClipFileAsync(ImportFileRequest request, CancellationToken cancellationToken = default);
    ...
    Task<AssetResponse> ImportAudioClipAsync(ImportAudioClipRequest request, CancellationToken cancellationToken = default);
}
